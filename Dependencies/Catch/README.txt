  ...
  License:
        ...
        The catch code is used by the PLCrashReporterA unit tests; it is not incorporated into the
        PLCrashReporterA library.
  Modifications:
...
XCTestRunner.mm
  ...
  License:
        MIT License
        The test runner code is only used by the PLCrashReporterA unit tests; it is not incorporated into the
        PLCrashReporterA library.
  Modifications:
